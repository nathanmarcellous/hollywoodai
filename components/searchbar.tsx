  ...
  return (
    <div className='w-full h-20 border-b border-[#f1f3f5]'>
      <div className='flex items-center px-8 justify-between mx-auto w-full max-w-[1400px] h-full relative'>
        ...
        <div className='absolute left-8 top-20 w-full max-w-[440px] z-10 shadow-[0_0_6px_0_rgba(0,0,0,.14)] rounded-[20px] max-h-[440px] overflow-y-auto border border-[#e1e7ea] hidden'>
          <h1 className='px-6 py-3 text-[16px] border-b border-[#e1e7ea]'>Search Results</h1>
          <div className='p-6 text-center font-medium text-[#1f2328]'>
            <h3>No results.</h3>
            <p>Please try again.</p>
          </div>
        </div>
        <RxHamburgerMenu size={24} className='text-[#1f2328]' />
      </div>
    </div>
  );
};
